...
public interface CloudsApi  {
    ...
    String OPERATION_ID_DELETEORDERCLOUDBYID = "deleteOrderCloudById";
    ...
    void deleteOrderCloudById(RequestParameter body, ServiceRequest request, Handler<AsyncResult<ServiceResponse>> resultHandler);
