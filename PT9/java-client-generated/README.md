...
- API version: 0.0.1
  - Build date: 2023-11-02T15:26:05.078352517Z[GMT]
...
*CloudsApi* | [**deleteOrderCloudById**](docs/CloudsApi.md#deleteOrderCloudById) | **DELETE** /clouds/{cloud_id} | Метод отмены заказа в облаке по ID
