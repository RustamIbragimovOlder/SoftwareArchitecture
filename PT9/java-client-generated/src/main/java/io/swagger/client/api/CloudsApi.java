...
public class CloudsApi {
    ...
    /**
     * Build call for deleteOrderCloudById
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deleteOrderCloudByIdCall(String cloudId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deleteOrderCloudByIdValidateBeforeCall(String cloudId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'cloudId' is set
        if (cloudId == null) {
            throw new ApiException("Missing the required parameter 'cloudId' when calling deleteOrderCloudById(Async)");
        }
        
        com.squareup.okhttp.Call call = deleteOrderCloudByIdCall(cloudId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void deleteOrderCloudById(String cloudId) throws ApiException {
        deleteOrderCloudByIdWithHttpInfo(cloudId);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> deleteOrderCloudByIdWithHttpInfo(String cloudId) throws ApiException {
        com.squareup.okhttp.Call call = deleteOrderCloudByIdValidateBeforeCall(cloudId, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteOrderCloudByIdAsync(String cloudId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteOrderCloudByIdValidateBeforeCall(cloudId, progressListener, progressRequestListener);
